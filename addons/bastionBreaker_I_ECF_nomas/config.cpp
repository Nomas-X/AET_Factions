...
class cfgVehicles
{
  ...
  class AET_F_bastionBreaker_I_ECF_TF_3_Fighter: SCR_TF3Fighter_SE
  {
    faction="AET_F_bastionBreaker_I_ECF_nomas";
    side=2;
    displayName="TF 3 Fighter";
    hiddenSelectionsTextures[]={"sc_ext_fixed\data\tf3\textures\body_black_se_co.paa","sc_fixed\data\fixed_bomber_01\details\details_co.paa","sc_ext_fixed\data\tf3\textures\wings_black_co.paa"};
    crew="AET_F_bastionBreaker_I_ECF_Pilot";
    typicalCargo[]={"AET_F_bastionBreaker_I_ECF_Pilot"};
  };
